...
public final class LayoutTabelAnggaranDesa1Binding implements ViewBinding {
  @NonNull
  ...
  private LayoutTabelAnggaranDesa1Binding(@NonNull RelativeLayout rootView,
      @NonNull GridLayout grid1, @NonNull LinearLayout layout1, @NonNull LinearLayout layout2,
      @NonNull LinearLayout layout3, @NonNull LinearLayout layout4,
  ...
  @NonNull
  public static LayoutTabelAnggaranDesa1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutTabelAnggaranDesa1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_tabel_anggaran_desa_1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutTabelAnggaranDesa1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutTabelAnggaranDesa1Binding((RelativeLayout) rootView, grid1, layout1, layout2,
          layout3, layout4, relativ1);
    }
